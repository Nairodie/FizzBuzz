...
namespace FizzBuzz.Tests
{
    ...
    {
        [Test]
        public void FizzBuzz_Returns_Fizz_When_Number_Is_Divisible_By_3()
        {
        ...
        [Test]
        public void FizzBuzz_Returns_Buzz_When_Number_Is_Divisible_5()
        {
            Assert.That(FizzBuzz.GetOutput(5), Is.StringMatching("Buzz"));
            Assert.That(FizzBuzz.GetOutput(10), Is.StringMatching("Buzz"));
            Assert.That(FizzBuzz.GetOutput(50), Is.StringMatching("Buzz"));
        }
